...
class ProductController{
    ...
    private initializeRouter= ()=>{
        this.router.post(`${this.path}`,validationMiddleware(productDto.create),this.createProduct)
    }
    ...
    private createProduct = async (
        ...
        try {
            ...
            if (typeof product ==="string"){
                ...
                res.status(201).json({Message:`New Product:${req.body.product_title} inserted`,Success:true})
            }
        } catch (error: any) {
